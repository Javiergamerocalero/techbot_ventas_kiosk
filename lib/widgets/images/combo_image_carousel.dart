...
/// Carrusel de imágenes para combos con rotación automática y controles manuales
class ComboImageCarousel extends ConsumerStatefulWidget {
  final Combo combo;
  final double height;
  final BorderRadius? borderRadius;

  const ComboImageCarousel({
    super.key,
    required this.combo,
  ...
  @override
  ConsumerState<ComboImageCarousel> createState() => _ComboImageCarouselState();
}

class _ComboImageCarouselState extends ConsumerState<ComboImageCarousel> {
  ...
  List<String> _getImageUrls() {
    ...
    if (widget.combo.images.isNotEmpty) {
      final sortedImages = widget.combo.sortedImages;
    ...
    if (urls.isEmpty && widget.combo.thumbnail.isNotEmpty) {
      urls.add(widget.combo.thumbnail);
    }
